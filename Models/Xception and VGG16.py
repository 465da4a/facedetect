...
Xception_model = tf.keras.applications.Xception(include_top=False, weights="imagenet", input_shape=(96,96,3))

#两种模型结合
vgg16_model = tf.keras.applications.vgg16.VGG16(include_top=False, weights="imagenet", input_shape=(96,96,3))


model_1 = Model(inputs=Xception_model.input, outputs=Xception_model.get_layer('block14_sepconv2_act').output)
